...
export const Normalize = createGlobalStyle`
    ...
    * {
    ...
    blockquote {
        border-left: 5px solid ${variable.color.primary};
        margin: 1rem 0;
        padding-left: 1.5rem;
    }
    ...
    html {
        > body {
            ...
            height: 100%;
            letter-spacing: ${variable.text.letterSpacing};
            line-height: ${variable.text.lineHeight};
            margin: 0;
            padding: 0;
            user-select: text;
            width: 100%;
    ...
    abbr[title] {
        border-bottom: 1px dotted ${variable.color.primary};
    }
    ...
    hr {
        ...
        height: 0;
        margin: ${variable.space.spacingMD} auto;
        width: 100%;
    }
